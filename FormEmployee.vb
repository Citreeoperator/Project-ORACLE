...
Public Class FormEmployee
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Bagohin()
            updates("UPDATE employee SET lastname = '" & txtLastname.Text & "', firstname = '" & txtFirstname.Text & "', mi='" & txtMI.Text & "', gender='" & txtGender.Text & "', address='" & txtAddress.Text & "', birthdate='" & txtBirthdate.Text & "', birthplace='" & txtBirthplace.Text & "', contactno='" & txtContact.Text & "', contactname='" & txtName.Text & "', relationship='" & txtRelationship.Text & "', contactaddress='" & txtAddressEmer.Text & "', noofcontact='" & txtContactEmer.Text & "', remarks='" & txtRemarks.Text & "' WHERE empid='" & txtID.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub btnDelete_Click_1(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Try
            Bura()
            delete("DELETE FROM employee where empid='" & txtID.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
