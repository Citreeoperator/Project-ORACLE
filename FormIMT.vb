...
Public Class FormIMT
    ...
    Sub Updating()
        ...
        If DataGridView1.Columns(e.ColumnIndex).Name = "edit" Then
            ...
            txtActivity.Text = dr.Cells(0).Value.ToString()
            txtDate.Text = dr.Cells(1).Value.ToString()
            txtLocation.Text = dr.Cells(2).Value.ToString()
            txtRemarks.Text = dr.Cells(3).Value.ToString()
    ...
    Sub VwGridview()
        ...
        Try
            reload("SELECT * FROM imt order by imtid DESC", DataGridView1)
        Catch ex As Exception
        ...
        Try
            With DataGridView1
                ...
                Else
                    ...
                    txtImtID.Text = .Rows(i).Cells(0).Value.ToString()
                    txtActivity.Text = .Rows(i).Cells(1).Value.ToString()
                    txtDate.Text = .Rows(i).Cells(2).Value.ToString()
                    txtLocation.Text = .Rows(i).Cells(3).Value.ToString()
                    txtRemarks.Text = .Rows(i).Cells(4).Value.ToString()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            create("INSERT INTO imt ( activity, date, location, remarks) VALUES ('" & txtActivity.Text & "', '" & txtDate.Text & "', '" & txtLocation.Text & "', '" & txtRemarks.Text & "')")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Bagohin()
            updates("UPDATE imt SET activity = '" & txtActivity.Text & "', date = '" & txtDate.Text & "', location='" & txtLocation.Text & "', remarks='" & txtRemarks.Text & "' WHERE imtid='" & txtImtID.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub btnDelete_Click_1(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Try
            Bura()
            delete("DELETE FROM imt where imtid='" & txtImtID.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub FormIMT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        VwGridview()
    End Sub
