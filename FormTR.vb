...
Public Class FormTR
    ...
    Sub Updating()
        ...
        If DataGridView1.Columns(e.ColumnIndex).Name = "Edit" Then
            ...
            txtTrid.Text = dr.Cells(0).Value.ToString()
    ...
    Sub clickGridView()
        ...
        Try
            With DataGridView1
                ...
                Else
                    i = .CurrentRow.Index
                    txtTrid.Text = .Rows(i).Cells(0).Value.ToString()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Try
            create("INSERT INTO transfer_request (date, name, patientcase, age, gender, address, contactname, relationship, contactno, origin, destination, driver, refer, request, dispatch, remarks) VALUES ('" & txtDate.Text & "', '" & txtName.Text & "', '" & txtCase.Text & "', '" & txtAge.Text & "', '" & cmbGender.Text & "', '" & cmbAddress.Text & "', '" & txtCName.Text & "', '" & txtRelation.Text & "', '" & txtContact.Text & "', '" & txtOrigin.Text & "', '" & txtDestination.Text & "', '" & cmbDriver.Text & "', '" & txtRefer.Text & "', '" & txtRequest.Text & "', '" & txtDispatch.Text & "', '" & txtRemarks.Text & "')")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Try
            Bagohin()
            updates("UPDATE transfer_request SET date = '" & txtDate.Text & "', name = '" & txtName.Text & "', patientcase='" & txtCase.Text & "', age='" & txtAge.Text & "', gender='" & cmbGender.Text & "', address='" & cmbAddress.Text & "', contactname='" & txtCName.Text & "', relationship='" & txtRelation.Text & "', contactno='" & txtContact.Text & "', origin='" & txtOrigin.Text & "', destination='" & txtDestination.Text & "', driver='" & cmbDriver.Text & "', refer='" & txtRefer.Text & "', request='" & txtRequest.Text & "', dispatch='" & txtDispatch.Text & "', remarks='" & txtRemarks.Text & "' WHERE trid='" & txtTrid.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub btnDelete_Click_1(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Try
            Bura()
            delete("DELETE FROM transfer_request where trid='" & txtTrid.Text & "'")
            clearfield()
            VwGridview()
        Catch ex As Exception
    ...
    Private Sub FormTR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        VwGridview()
    End Sub
