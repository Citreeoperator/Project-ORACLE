...
Public Class ReportIR
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        e.Graphics.DrawString("INCIDENT REPORT", New Font("Century Gothic", 14, FontStyle.Bold), Brushes.Black, New Point(10, 30))
        e.Graphics.DrawString("Date:" + DateTime.Now, New Font("Century Gothic", 12, FontStyle.Regular), Brushes.Black, New Point(10, 55))
